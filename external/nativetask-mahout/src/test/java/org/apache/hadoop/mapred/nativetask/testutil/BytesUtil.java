...
public class BytesUtil {
  ...
  private static Object newMahoutObject(byte[] seed, String className) {
    if (className.equals(VarIntWritable.class.getName())) {
      ...
      long taskItemOrdinal = Math.abs(toLong(seed, 4));
      ...
      Gram gram = new Gram(toStringBinary(seed, 0,
      ...
      for (int i = 0; i < tupleSize; i++) {
        ...
        stringTuple.add(toStringBinary(seed, index, seed.length - index));
      }
      return stringTuple;
    } else {
      return null;
