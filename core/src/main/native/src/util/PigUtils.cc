...
/* Boolean is 1 byte */
int PigUtils::PigNullableBooleanComparator(const char * src, uint32_t srcLength, const char * dest,
    uint32_t destLength) {
  ...
  int c = PigUtils::PigNullableWritableComparator(src, srcLength, dest, destLength, &NativeObjectFactory::ByteComparator);
...
/* Int is 4 bytes */
int PigUtils::PigNullableIntComparator(const char * src, uint32_t srcLength, const char * dest,
    uint32_t destLength) {
  ...
  int c = PigUtils::PigNullableWritableComparator(src, srcLength, dest, destLength, &NativeObjectFactory::IntComparator);
  if (c != 0 && !PigUtils::getSortOrder())
    c *= -1;
  return c;
}
...
/* Long is 8 bytes */
int PigUtils::PigNullableLongComparator(const char * src, uint32_t srcLength, const char * dest,
    uint32_t destLength) {
  ...
  int c = PigUtils::PigNullableWritableComparator(src, srcLength, dest, destLength, &NativeObjectFactory::LongComparator);
  if (c != 0 && !PigUtils::getSortOrder())
    c *= -1;
  return c;
}
...
/* Float is 4 bytes */
int PigUtils::PigNullableFloatComparator(const char * src, uint32_t srcLength, const char * dest,
    uint32_t destLength) {
  if ((srcLength != 2 && srcLength != 6) || (destLength != 2 && destLength != 6)) {
    THROW_EXCEPTION(IOException,
        "Pig NullableFloatWritable comparator, while src/dest length is not 2 or 6");
  }
  int c = PigUtils::PigNullableWritableComparator(src, srcLength, dest, destLength, &NativeObjectFactory::FloatComparator);
  if (c != 0 && !PigUtils::getSortOrder())
    c *= -1;
  return c;
}
...
/* Double is 8 bytes */
int PigUtils::PigNullableDoubleComparator(const char * src, uint32_t srcLength, const char * dest,
    uint32_t destLength) {
  if ((srcLength != 2 && srcLength != 10) || (destLength != 2 && destLength != 10)) {
    THROW_EXCEPTION(IOException,
        "Pig NullableDoubleWritable comparator, while src/dest length is not 2 or 10");
  }
  int c = PigUtils::PigNullableWritableComparator(src, srcLength, dest, destLength, &NativeObjectFactory::DoubleComparator);
  if (c != 0 && !PigUtils::getSortOrder())
    c *= -1;
  return c;
}
...
int PigUtils::PigNullableDateTimeComparator(const char * src, uint32_t srcLength, const char * dest,
    uint32_t destLength) {
...
int PigUtils::PigNullableTextComparator(const char * src, uint32_t srcLength, const char * dest,
    uint32_t destLength) {
...
int PigUtils::PigNullableTupleComparator(const char * src, uint32_t srcLength, const char * dest,
    uint32_t destLength) {
 ...
 */
int PigUtils::PigNullableBytesComparator(const char * src, uint32_t srcLength, const char * dest,
    uint32_t destLength) {
  int c = PigUtils::PigNullableWritableComparator(src, srcLength, dest, destLength,
...
ComparatorPtr PigUtils::getPigComparator(const PigWritableType keyType) {
