...
public class EnforceNativeOutputCollectorDelegator<K, V> extends NativeMapOutputCollectorDelegator<K, V> {
  private static Log LOG = LogFactory.getLog(EnforceNativeOutputCollectorDelegator.class);
 ...
 throws IOException, ClassNotFoundException {
    try {
      ...
      String message = "load nativetask lib failed, Native-Task Delegation is disabled";
