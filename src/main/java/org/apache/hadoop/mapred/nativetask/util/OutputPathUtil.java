 ...
 * they need to write to/read from for intermediate files. The callers of these
 * methods are from child space and see mapreduce.cluster.local.dir as
 * taskTracker/jobCache/jobId/attemptId This class should not be used from
 * TaskTracker space.
 */
public class OutputPathUtil {
  ...
  public Path getOutputFile() throws IOException {
    ...
    System.out.println("###LOCALDIRSETTING: " + conf.get("mapred.local.dir"));
    
    return lDirAlloc.getLocalPathToRead(TASKTRACKER_OUTPUT + Path.SEPARATOR
        + "file.out", conf);
  }
  ...
  public Path getOutputFileForWrite(long size) throws IOException {
    return lDirAlloc.getLocalPathForWrite(TASKTRACKER_OUTPUT + Path.SEPARATOR
        + "file.out", size, conf);
  }
  ...
  public Path getSpillFile(int spillNumber) throws IOException {
    return lDirAlloc.getLocalPathToRead(TASKTRACKER_OUTPUT + "/spill"
  ...
  public Path getInputFile(int mapId) throws IOException {
    return lDirAlloc.getLocalPathToRead(String.format(
        REDUCE_INPUT_FILE_FORMAT_STRING, TASKTRACKER_OUTPUT,
        Integer.valueOf(mapId)), conf);
  }
  ...
  public Path getInputFileForWrite(TaskID mapId, long size) throws IOException {
    return lDirAlloc.getLocalPathForWrite(String.format(
        REDUCE_INPUT_FILE_FORMAT_STRING, TASKTRACKER_OUTPUT, mapId.getId()),
        size, conf);
  }
